...
module Datasource
  # this imports from a custom export file generated by an sql script from a the postgresql database at fiz-karlsruhe.de
  # which in turn has been generated from WOS data! No way yet to use real WOS export files
