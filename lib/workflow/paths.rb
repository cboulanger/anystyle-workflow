...
module Workflow
  class Path
    class << self
      ...
      # path to the directory containing files with anystyle parser xml
      # @return [String]
      def anystyle_parser_xml
        File.join(base, '3-anystyle-xml')
      end

      # path to the directory containing files with anystyle finder xml
      # @return [String]
      def anystyle_finder_xml
        File.join(base, '3-anystyle-finder-xml')
      end
      ...
      # path to the directory containing files with the TEI XML generated by
      # GROBID from the PDF files
      # @return [String]
      def grobid_tei
